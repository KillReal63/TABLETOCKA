...
for(const [h,theme] of [[0,'plum'],[5,'plum'],[6,'glass'],[13,'glass'],[14,'tide'],[21,'tide'],[22,'plum'],[23,'plum']]){hour=h;tick();assert.equal(document.documentElement.dataset.theme,theme)}
